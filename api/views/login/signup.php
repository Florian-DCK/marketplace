...
<form action="" method="" class="h-screen flex flex-col justify-center items-center">
    ...
    <div class="flex mb-8 p-2 rounded-sm bg-[#EAEBED] w-md">
        ...
        <input type="text" name="email" class="p-1 text-[#9F9F9F] w-full focus:outline-none" placeholder="Name">
    </div>
    <div class="flex mb-8 p-2 rounded-sm bg-[#EAEBED] w-md">
    ...
    <div class="flex mb-8 p-2 rounded-sm bg-[#EAEBED] w-md">
        ...
        <input type="password" name="confirm_password" class="p-1 text-[#9F9F9F] w-full focus:outline-none" placeholder="Confirm password">
    </div>
