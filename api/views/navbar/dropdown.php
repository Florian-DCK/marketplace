...
<div>
    <svg id="menu-button" xmlns="http://www.w3.org/2000/svg" fill="none" class="size-6 cursor-pointer hover:bg-gray-300 rounded-md stroke-black" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-width="1.5" d="M20 7H4M20 12H4M20 17H4"/></svg>
